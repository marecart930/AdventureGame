        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            switch (page)
            {
                ...
                case 12:
                    ...
                    Refresh();
                    Thread.Sleep(3000);
                    topLabel.Text = $"The store explodes and you die...\n...wait...You wake up and realize it was all a dream";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (page)
            {
                ...
                case 5:
                    ...
                    bottomLabel.Text = "Interact with him?";
                    button1.Text = "Yes";
                    button2.Text = "";
                    button3.Text = "No";
                    //pictureBox1.Image = Properties.Resources.blank;
...
//6 2 8 3 8 17
//resources need to be added back for images
//test play again and quit buttons 
